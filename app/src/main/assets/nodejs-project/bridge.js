...
const USAGE = require('./bridge/usage.js')(FILES_DIR);
...
// ─────────────────────────────────────────────────────────────────────────
const RTK = require('./bridge/rtk.js');
...
const { anthToOai, oaiToAnth, flattenToolHistory, extractThoughtSig, storeThoughtSig, cleanToolName } = require('./bridge/format.js')(log);
